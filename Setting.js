...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://king:sukuna@kingsukuna.ojohuwq.mongodb.net/?retryWrites=true&w=majority&appName=kingsukuna" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
global.timezone  = process.env.TIME_ZONE || 'Lagos/Nigeria' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "2347014128473" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"𝕮♥︎𝖝♥︎𝕲",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '24_06_2024_SIGMA_MD_Wyc96L6S_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || '𝛫𝛪𝛮𝐺 𝑆𝑈𝛫𝑈𝛮𝛥 𝑅𝑌𝛩𝛭𝛯𝛮',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𝑲𝑰𝑵𝑮_𝑺𝑼𝑲𝑼𝑵𝑨✞ᵍʳᵉʸ✞`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝑲𝑰𝑵𝑮_𝑺𝑼𝑲𝑼𝑵𝑨',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "✞ᵍʳᵉʸ✞" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝑲𝑰𝑵𝑮_𝑺𝑼𝑲𝑼𝑵𝑨✞ᵍʳᵉʸ✞",
